...
class Controller:
    ...
    def show_menu(self):
        ...
        self.view.show_message("6. generate N elements ")
        self.view.show_message("7. Update record")
        self.view.show_message("8. Search teachers with TEXT in name :p")
    ...
    def view_table(self):
        ...
        rows = self.model.view_table(table)
    ...
    def add_record(self):
        ...
        if table == "Student":
            if self.model.add_student(*data):
                ...
                self.view.show_message("Error: cannot add student.")

        elif table == "Teacher":
            if self.model.add_teacher(*data):
                self.view.show_message("Teacher added.")
            else:
                self.view.show_message("Error: cannot add teacher.")

        elif table == "Subject":
            if self.model.add_subject(*data):
                self.view.show_message("Subject added.")
            else:
    ...
    def delete_record(self):
        ...
        if self.model.delete_elem(table, record_id):
    ...
    def Update(self):
        ...
        if table == "Student":
            ...
            if self.model.update_student(id, name, birth_date, stud_id):
            ...
            if self.model.update_teacher(id, name, birth_date, tch_id):
            ...
            if self.model.update_subject(id, name, hours_per_week, new_subject_id, tch_id):
